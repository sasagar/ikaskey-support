...
本利用規約（以下、本規約）は、bktsk.com（以下、「管理者」といいます）の運営する分散型 SNS Misskey サーバー「いかすきー」（以下「本サービス」といいます）の利用要件を定めるものです。登録者の皆様（以下、ユーザー）には、利用にあたり本規約に同意していただく必要がございます。

ご利用いただく際は、下記ルールを基準にマナーを守ってご利用いただくようお願いします。
...
3項. 未成年者が登録を行う場合において、登録申請を以て保護者の同意を得た物とし、本サービスの利用に際して発生するいかなる事象においても管理者はその責を負わないものとします。
...
[プライバシーポリシーはこちらからご確認できます](../privacy-policy/)
...
11. 以下を目的とし、または目的とすると管理者が判断する行為
    ...
    - 一般的でないサービスへ誘導する行為
    - MFMによる文字装飾やアスキーアート等で露骨に性的な内容を含む投稿 (リノートを含む)
...
5. 登録者の情報や投稿に無断転載などが認められ、権利者の権利を侵害すると判断された場合
6. 別途定める各モデレーション基準に該当した場合
7. その他管理者が本サービスの利用を適当でないと判断する場合

[モデレーション基準はこちらから確認できます](/terms/other-terms.html)
...
管理者はユーザーへの事前の告知をもって本サービスの内容を変更、追加または廃止することがあり、ユーザーは退会等契約を終了せず継続して利用した時点でこれに承諾したものと見做します。
...
2項. 本サービスに関して紛争が発生した場合には管理人の所在地である東京地方裁判所を専属的合意管轄とします。
...
- 2023/07/11 v2.1.0 禁止事項の追加
- 2023/07/07 v2.0.0 全体的な条文見直しによる全面改定
...
代表者 ＠mantaro スーパーマンタロー 連絡先 <bktsk@bktsk.com>
